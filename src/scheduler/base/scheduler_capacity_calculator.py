...
class SchedulerCapacityCalculator:
    ...
    def _calculate_bits_transmitted_in_downlink_resource_block(self, scheduled_users, current_slot):
        ...
        for user_equipment in scheduled_users:
            ...
            user_equipment.record_transmission_slot(current_slot)

            transmission_detail = f"Slot {current_slot}: {user_equipment.unique_id}, UE ({user_equipment.x:.2f},{user_equipment.y:.2f}), Bits transmitted = {bits_transmitted_per_user_equipment}"
