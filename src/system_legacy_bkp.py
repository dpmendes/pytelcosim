...
#// Backup for working system class after matlab port release for system class. Delete it later
#// Use it for reference when refactoring the system;
...
# //============================================================================
    ...
    def find_base_station(self, base_station):
        return base_station in self.base_stations_list

    def find_user_equipment(self, user_equipment):
        return user_equipment in self.user_equipment_list
    ...
    def find_links_to_base_station(self, base_station: BaseStation) -> List[UserEquipmentToBaseStationLink]:
        return [link for link in self.user_equipment_to_base_station_links_list
    ...
    def calculate_downlink_round_robin_aggregate_throughput_over_number_of_slots(self, number_of_slots):
        ...
        results_file = self.open_results_file('round_robin_scheduling.txt')
