...
class TestSchedule(unittest.TestCase):
    ...
    def test_addUserToResourceBlock(self):
        ...
        print("Users in Resource Blocks:", self.schedule.usersInResourceBlocks)
    ...
    #     print("Users in Resource Blocks after shift:", self.schedule.usersInResourceBlocks)
    ...
    def test_getUserInResourceBlock(self):
        ...
        print("User in Resource Block 0:", self.schedule.getUserInResourceBlock(0))
        print("User in Resource Block 1:", self.schedule.getUserInResourceBlock(1))
    ...
    def test_set_and_get_base_station(self):
        ...
        print("Base station:", self.schedule.getBaseStation())
